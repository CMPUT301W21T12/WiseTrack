...
public class StatReportActivity extends AppCompatActivity {
    ...
    private float [] trialData = new float[]{42, 3, 4, 7, 18, 21, 26, 44, 69, 10}; // tester array to be put into  an actual test later
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView exprName = (TextView) findViewById(R.id.stats_report_experiment_name); // Extracted from experiment.name from firebase
